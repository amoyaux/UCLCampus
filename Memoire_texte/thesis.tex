...
\subsection{Colors}
We used the colors code of the UCL\footnote{https://www.uclouvain.be/459461.html}. For this we modified the sass theme of Ionic so module developed with basic ionic css should update to application color instantly. 
\section{Security}
